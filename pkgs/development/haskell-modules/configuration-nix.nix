...
self: super: builtins.intersectAttrs super {
  ...
  hercules-ci-agent = super.hercules-ci-agent.override { nix = pkgs.nixVersions.hercules-ci; };
  hercules-ci-cnix-expr = super.hercules-ci-cnix-expr.override { nix = pkgs.nixVersions.hercules-ci; };
  hercules-ci-cnix-store = super.hercules-ci-cnix-store.override { nix = pkgs.nixVersions.hercules-ci; };
